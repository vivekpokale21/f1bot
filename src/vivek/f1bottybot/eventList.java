...
public class eventList {
    static ArrayList<f1> returnAL() throws FileNotFoundException {
        ...
        String list = "Bahrain Grand Prix\t\tFree Practice 1\t\t03\t\t18\t\t16\t\t0\n" +
                ...
                "Bahrain Grand Prix\t\tRace\t\t03\t\t20\t\t19\t\t0\n" +
                ...
                "Saudi Arabian Grand Prix\t\tRace\t\t03\t\t27\t\t21\t\t0\n" +
                ...
                "Australian Grand Prix\t\tRace\t\t4\t\t10\t\t9\t\t0\n" +
                ...
                "Emilia Romagna Grand Prix\t\tRace\t\t4\t\t24\t\t17\t\t0\n" +
                ...
                "Miami Grand Prix\t\tRace\t\t5\t\t8\t\t23\t\t30\n" +
                ...
                "Monaco Grand Prix\t\tRace\t\t5\t\t29\t\t17\t\t0\n" +
                ...
                "Azerbaijan Grand Prix\t\tRace\t\t6\t\t12\t\t15\t\t0\n" +
                ...
                "Canadian Grand Prix\t\tRace\t\t6\t\t19\t\t22\t\t0\n" +
                ...
                "British Grand Prix\t\tRace\t\t7\t\t3\t\t18\t\t0\n" +
                ...
                "Austrian Grand Prix\t\tRace\t\t7\t\t10\t\t17\t\t0\n" +
                ...
                "French Grand Prix\t\tRace\t\t7\t\t24\t\t17\t\t0\n" +
                ...
                "Hungarian Grand Prix\t\tRace\t\t7\t\t31\t\t17\t\t0\n" +
                ...
                "Belgian Grand Prix\t\tRace\t\t8\t\t28\t\t17\t\t0\n" +
                ...
                "Dutch Grand Prix\t\tRace\t\t9\t\t4\t\t17\t\t0\n" +
                ...
                "Italian Grand Prix\t\tRace\t\t9\t\t11\t\t17\t\t0\n" +
                ...
                "Singapore Grand Prix\t\tRace\t\t10\t\t2\t\t16\t\t0\n" +
                ...
                "Japanese Grand Prix\t\tRace\t\t10\t\t9\t\t9\t\t0\n" +
                ...
                "United States Grand Prix\t\tRace\t\t10\t\t23\t\t23\t\t0\n" +
                ...
                "Mexico City Grand Prix\t\tRace\t\t10\t\t31\t\t0\t\t0\n" +
                ...
                "Brazilian Grand Prix\t\tRace\t\t11\t\t13\t\t22\t\t0\n" +
