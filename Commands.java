...
public class Commands extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        else if(args[0].equalsIgnoreCase(f1bot.prefix+"sanika")){event.getChannel().sendMessage("That's not how you spell `+sunnyka`. Get it right.").queue();}
        else if(args[0].equalsIgnoreCase(f1bot.prefix+"sunnyka")){event.getChannel().sendMessage("Bitxh what").queue();}
